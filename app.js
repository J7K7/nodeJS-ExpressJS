...
const { scheduleSlotAddition } = require("./scheduler/slotSheduler");
...
// Below is slot Scheduler which is responsible for Adding the slot of next day and removing slots for previous day
scheduleSlotAddition();
